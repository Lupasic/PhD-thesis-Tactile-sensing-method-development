...
\title[Oleg's Bulichev PhD Thesis]{Tactile sensing method development for a mobile multilegged robot in a cave environment} %% that will be typeset on the
...
\framesubtitle{Question: how to make a terrain map?}
