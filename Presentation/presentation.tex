...
\begin{frame}[t]{Robot design}
    ...
    \vspace{-0.6cm}
    Вставить видео как робот ходит по сгенерированной истории
    % \begin{figure}[H]
    %     \href{}{
    %         \centering\includegraphics[height=6cm,width=1\textwidth,keepaspectratio]{file_name}}
...
\begin{frame}[t]{Robot design}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.32\textwidth}
            ...
            \caption*{\textbf{2nd gen}: 12 legs \\ 2 segments, 1 DoF connection \\ Continuous leg to body angle up to 45 deg}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.32\textwidth}
            \centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{strirus_2.jpg}
            \caption*{\textbf{3rd gen}: 12 legs \\ 2 segments, 2 DoF connection \\ Discrete leg to body angle up to 45 deg}
        \end{subfigure}
        \hfill
    \end{figure}
\end{frame}
...
\begin{frame}[t]{Robot design}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \caption*{\textbf{4th gen}: 10 biggest legs \\ 2 segments, 1 DoF connection \\  Discrete leg to body angle up to 15 deg}
        \end{subfigure}
        \hfill
    \end{figure}
\end{frame}
...
\begin{frame}[t]{Experiment Design}
    ...
    \vspace{-15pt}
    \begin{figure}[H]
        \href{https://youtu.be/Sw0xCt78gIg}{
...
\begin{frame}[t]{Map creation based on tactile data}
\framesubtitle{Result: real world experiment}
Вставить видео из реального эксперимента и все это
    % \begin{figure}[H]
    %     \begin{subfigure}{0.49\textwidth}
    %         \href{}{
    %             \centering\includegraphics[height=6cm,width=1\textwidth,keepaspectratio]{file_name}}
    ...
    %     \end{subfigure}
    %     \begin{subfigure}{0.49\textwidth}
    %         \centering\includegraphics[height=6cm,width=1\textwidth,keepaspectratio]{file_name2}
    %         \caption{capture2}
