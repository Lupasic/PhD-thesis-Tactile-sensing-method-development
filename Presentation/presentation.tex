...
\begin{frame}[t]{Robot design}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{c|c|c|c|c}
         & \textbf{\begin{tabular}[c]{@{}c@{}}Terrain\\ types\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}No. legs\\ per side\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Angle b/w\\ neighbor legs\end{tabular}} & \textbf{No. individuals} \\
         \hline
         \rule{0cm}{0.5cm}
        \textbf{Phase 1} &  & \cellcolor[HTML]{DAE8FC}6 & 73 & 200 \\ \cline{1-1} \cline{3-5} 
         & \multirow{-2}{*}{\begin{minipage}{2.5cm}\includegraphics[height=3cm,width=2.5cm,keepaspectratio]{terrain_1.jpg}\end{minipage}} & \cellcolor[HTML]{DAE8FC}6 & 72 &  \\ [0.5cm] \cline{3-4} 
         & \begin{minipage}{2.5cm}\includegraphics[height=3cm,width=2.5cm,keepaspectratio]{terrain_2.jpg}\end{minipage} & \cellcolor[HTML]{DAE8FC}5 & 68 &  \\ [0.5cm] \cline{3-4}
        \multirow{-3}{*}{\textbf{Phase 2}} & \begin{minipage}{2.5cm}\includegraphics[height=3cm,width=2.5cm,keepaspectratio]{terrain_3.jpg}\end{minipage} & \cellcolor[HTML]{DAE8FC}6 & 77 & \multirow{-3}{*}{55}
        \end{tabular}
