            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    ...
                    \begin{scope}[
                        ...
                        \draw[thick,green] (6.7,4) -- (5.75,9);
                        \draw[thick,green] (4.85,3.5) -- (5.75,9);
                        \draw[thick,green] (6.32,6) arc (-79.2:-99.2:3) node [rounded corners=3pt,below = 2pt,black,fill=white, midway] {\tiny $x$};
                ...
                \centering
                 \begin{tikzpicture}
                    ...
                    \begin{scope}[
                        ...
                        \draw[stealth-, very thick,green] (4.2,2.8) -- (6.5,5);
                        \draw[stealth-, very thick,green] (8.8,2.1) -- (6.5,5)
                ...
                \centering
                 \begin{tikzpicture}
                    ...
                    \begin{scope}[
                        ...
                        % Labels
                        \draw[stealth-, very thick,green] (5.5,3.5) -- ++(0.7,-1)
                        ...
                        \draw[stealth-, very thick,green] (3.4,0.8) -- (4.8,1);            
