\documentclass[aspectratio=169,xcolor=table,10pt, notes]{beamer}
...
\note{Вашему вниманию предлагается работа тема работы - Разработка метода тактильного очувствления для мобильного шагающего робота.}

\fbckg{fibeamer/figs/common.png}

\input{slides_intro.tex}
\input{slides_robot_optim.tex}
\input{slides_sensor.tex}
\input{slides_phys.tex}
\input{slides_geom.tex}
\input{slides_concl.tex}
