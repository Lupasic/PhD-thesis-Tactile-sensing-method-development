...
\addbibresource[label=bl-triangulation]{biblio/triangulation_bib.bib}
\addbibresource[label=bl-master]{biblio/master_thesis.bib}
...
\DeclareSourcemap{ %модификация bib файла перед тем, как им займётся biblatex
    \maps{
        ...
        \map[overwrite]{ % добавляем ключевые слова, чтобы различать источники
            ...
            \perdatasource{biblio/master_thesis.bib}
            \step[fieldset=keywords, fieldvalue={,biblioexternal},append=true]
            \perdatasource{biblio/triangulation_bib.bib}
            \step[fieldset=keywords, fieldvalue={,biblioexternal},append=true]
        }
        \map[overwrite]{ % добавляем ключевые слова, чтобы различать источники
