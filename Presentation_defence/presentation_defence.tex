...
\begin{frame}[t]{Литературный обзор}
    ...
    \begin{itemize}
        ...
        \item Способы получения силы реакции опоры. \\ \alert{-- Неявные и явные способы. Классификая типов датчиков силы}
        \item Методы определения типа поверхности. \\ \alert{-- С помощью машинного обучения, используя набор датчиков}
