...
\subtitle{Автор: Олег Буличев \\ \  \\ \ } %% title page.
\author{Олег Буличев}
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.48\textwidth}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.99\textwidth}
                    \centering\includegraphics[height=2cm,width=1\textwidth,keepaspectratio]{../images/f3.png}
...
\begin{frame}[t]{Картографирование с помощью датчиков силы}
    \framesubtitle{Предположения}
    \large
    Текущее решение с учетом предположений:
    \begin{itemize}
