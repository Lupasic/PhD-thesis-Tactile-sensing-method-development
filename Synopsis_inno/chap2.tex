...
\textbf{{Вторая глава}} покрывает разработку объекта исследования, а именно решение задачи структурного синтеза и инженерную разработку прототипа.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        {\centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{best_gen_robot.jpg}};
...
\begin{table}[H]
    ...
    % \begin{center}
    \begin{footnotesize}
    \begin{tabular}{p{2.2cm}|p{2.1cm}|p{2cm}|p{2.1cm}|p{2cm}|p{2cm}}
    \toprule
    \toprule
    % \rowcolor{Gray}
    ...
    %  \rowcolor{lightgray}
     Отн. угол тело -- нога, градусы & 0 & 0--45 & 0, 15, 30, 45 & 0 & 0, 15 \\
