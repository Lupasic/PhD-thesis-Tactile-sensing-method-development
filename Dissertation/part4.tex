...
\section{Метод для классификации свойств поверхностей}
...
\section{Экспериментальная установка для обучения определения физико-механических свойств поверхности}
