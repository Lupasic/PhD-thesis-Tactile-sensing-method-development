...
\begin{figure}[h]
    \begin{subfigure}[t]{0.45\textwidth}
        \centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{velostat_sensor.jpg}
        \caption{Материал Velostat}
        \label{fig:velostat_sensor.jpg}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
        \centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{simplest_sensor.jpg}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        {\centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{velostat_pressure_resistance.jpg}};
...
\begin{figure}[H]
    \centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{least_square_model.png}
